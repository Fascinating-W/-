  ...
  <div class="fillContainer">
    <div>
      <el-form :inline="true" ref="add_data" :model="search_data">
        ...
        <el-form-item>
          <el-button type="primary" size="small" icon="search" @click="handleSelect">筛选</el-button>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="date" label="创建时间" align="center" width="280" sortable>
          <template slot-scope="scope">
            ...
            <span style="margin-left: 10px">{{ scope.row.date | displaydate }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" width="200" v-if="user.identity=='manager'">
          <template slot-scope="scope">
            <el-button
              type="success"
              size="small"
  ...
  methods: {
    ...
    setPaginations() {
      ...
      this.tableData = this.allTableData.filter((item, index) => {
        return index < this.paginations.page_size //展示5条
      })
    },
